"""Command-line interface for the Git-backed ene resource library."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    console = Console()
    library_logger = logging.getLogger("ene.library")
    ...
    if args.verbose:
        ...
        verbose_handler.setFormatter(logging.Formatter("[ene lib] %(message)s"))
