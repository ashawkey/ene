...
# Results live in their own directory under .ene so a run is resumable across
# sessions and safe from `ene --clean`, which preserves this entry. A run is
                    ...
                    "properties": {
                        ...
                        "name": {
                            ...
                            "description": (
                                ...
                                f".ene/{BATCH_DIR_NAME}/<name>.jsonl, one record per item: "
