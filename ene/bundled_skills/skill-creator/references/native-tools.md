...
relative imports. If `describe` is omitted, ene uses a generic, redacted
...
The schema guides the model, but ene does not guarantee runtime JSON Schema
...
Loading `tools.py` executes it in the ene process. For this personal harness,
