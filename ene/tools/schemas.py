...
``registry.py`` via :class:`~ene.tools.registry.ToolSpec`, so there is a
...
_BUILTIN_TOOL_SCHEMAS_LIST = [
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "label": {
                        "type": "string",
                        "description": "Concise human-readable process label (optional)",
                    },
                },
                "required": ["command"],
            },
    ...
    },
    {
        ...
        },
        {
            ...
            "function": {
                "name": "web_fetch",
                "description": "Fetch a public HTTP(S) URL and convert its content to readable text. Uses a 30-second overall timeout.",
                "parameters": {
                    "type": "object",
                    "properties": {
