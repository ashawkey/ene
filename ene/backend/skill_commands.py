...
class SkillCommandsMixin:
    ...
    def _skills_summary(self) -> str:
        ...
        from ene.personas import filter_persona_skills
        from ene.skills import build_skills_prompt_section
        ...
        # A persona template may omit {{ene:skills}} entirely, in which case
    ...
    def _list_skills(self):
        """List bundled, project, and personal ene skills."""
        if not self.skills:
            from ene.skills import SKILL_DIRS
        ...
        from ene.skills import validate_skill
